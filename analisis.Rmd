...
#busquedas_caba <- opq(bbox_caba)

#busquedas_caba <- add_osm_feature(busquedas_caba, key = "leisure", value = c("park", "garden", "nature_reserve"))

#busquedas_caba <- osmdata_sf(busquedas_caba)
```
