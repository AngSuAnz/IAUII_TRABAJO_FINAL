...
```{r barrios_puntos, warning=FALSE, hide=TRUE}
...
#st_write(puntos_aleatoriossv, "data/puntos_aleatoriossvk.geojson")

puntos_aleatorios = st_read("data/nuevos_puntos_finalisimo.geojson")

```


```{r construccion_isocronas, warning=FALSE, hide=TRUE}
...
#st_write(isocronas_bindsv, "data/isocronas_fnalisimo.geojson")



#Ahora simplemente llamo la base que armé y le uno los nombres por orden de las observaciones
isocronas_barrios = st_read("data/isocronas_finalisimo.geojson") %>% 
                    st_transform(4326) %>% 
...
```{r mapa_isocronas, echo=FALSE, warning=FALSE, hide=TRUE}
mapa_isocronas =
...
```{r cuadro_bases_de_datos,echo = FALSE, warning=FALSE, hide=TRUE}
...
```{r bbox_funciones, echo=FALSE, warning=FALSE, hide=TRUE}
...
```{r autoabastecimiento, echo=FALSE, warning=FALSE, hide=TRUE}
#AUTOABASTECIMIENTO--------------------------------------------------------------
...
```{r cultura, echo=FALSE, warning=FALSE, hide=TRUE}
# CULTURA------------------------------------------------------------------------
...
```{r recreacion, echo=FALSE, warning=FALSE, hide=TRUE}
# RECREACION----------------------------------------------------------
...
```{r deportes, echo=FALSE, warning=FALSE, hide=TRUE}
#DEPORTES-------------------------------------------------------------------------
...
```{r educacion, echo=FALSE, warning=FALSE, hide=TRUE}
#EDUCACION----------------------------------------------------------------------
...
```{r medio_ambiente, echo=FALSE, warning=FALSE, hide=TRUE}
#MEDIO AMBIENTE-------------------------------------------------------------------
...
```{r salud, echo=FALSE, warning=FALSE, hide=TRUE}
# SALUD-------------------------------------------------------------------------
...
```{r seguridad, echo=FALSE, warning=FALSE, hide=TRUE}
# SEGURIDAD---------------------------------------------------------------------
...
```{r tramites, echo=FALSE, warning=FALSE, hide=TRUE}
...
```{r transporte, echo=FALSE, warning=FALSE, hide=TRUE}
...
```{r unificado, echo=FALSE, warning=FALSE, hide=TRUE}
